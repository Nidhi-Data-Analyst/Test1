            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 340px; table-layout: fixed;">
                <tr>
                    <td style="vertical-align: top; padding-right: 5px; text-align: center; width: 120px">
                        ...
                        <br>
                        <img src="${githubBaseUrl}school_logo14.jpg?raw=true" alt="School Logo" class="school-logo" style="width:100%; max-width:120px; display: block; margin: 3px auto 0;">
                        <div class="school-locations" style="font-size: 6px; color: #0d56a2; text-align: center; margin-top: 2px;">
